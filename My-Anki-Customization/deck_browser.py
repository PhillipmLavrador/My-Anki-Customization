...
def renderStats(self, _old):
    ...
    <div class='row align-items-center full   stats' style="background-color: {BROWSER[overview-wedgit-bg]} ">
            <div class="col col-2 ">
                <svg width="3em" height="4.5em" viewBox="0 0 16 16" class="bi bi-card-checklist" fill="{BROWSER[wedgits-font-color]}" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="row align-items-center full">
        ...
        <div class='col col-6  stats half left ' style="background-color: {BROWSER[average-wedgit-bg]}">
            <div class="row align-items-center">
                    <div class="col col-4">
                        <svg width="3em" height="4.2em" viewBox="0 0 16 16" class="bi bi-watch" fill="{BROWSER[wedgits-font-color]}" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class='col col-6  stats half right ' style="background-color:  {BROWSER[remaining-wedgit-bg]}">
            <div class="row align-items-center">
                <div class="col col-4">
                    <svg width="3em" height="4.2em" viewBox="0 0 16 16" class="bi bi-stopwatch-fill" fill="{BROWSER[wedgits-font-color]}" xmlns="http://www.w3.org/2000/svg">
...
<!--------------------END ROW 2----------------------------->
    ...
    <div class="row align-items-center full">
        ...
        <div class="row align-items-center">
        <div class="col col-4">
            <svg width="3em" height="4.2em" viewBox="0 0 16 16" class="bi bi-layers-fill" fill="{BROWSER[wedgits-font-color]}" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class='col col-6  stats  half right'style="background-color: {BROWSER[due-wedgit-bg]}">
            <div class="row align-items-center">
                <div class="col col-4">
                    <svg width="3em" height="4.2em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="{BROWSER[wedgits-font-color]}" xmlns="http://www.w3.org/2000/svg">
